...
> 
> Check out the [`v3.1`](https://github.com/ClearAnatomics/ClearMap/tree/v3.1.x) branch to try it early, and please [report any issues](https://github.com/ClearAnatomics/ClearMap/issues).
