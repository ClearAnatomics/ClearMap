...
def compare(
    ...
    ----------
    img_0 : str | np.ndarray
        binary image or path to binary image for channel 0, as generated by cell_map
    df_0 : str | pd.DataFrame
        dataframe or path to feather file for channel 0, as generated by cell_map
    img_1 : str | np.ndarray
        binary image or path to binary image for channel 1, as generated by cell_map
    df_1 : str
        dataframe or path to feather file for channel 1, as generated by cell_map
    scale : array like
    ...
    size_min : int
        minimum size of blobs to consider
    size_max : int
        maximum size of blobs to consider
    processes : int | None
    ...
    max_coord_cols = [f"maximizing blob bbox center {coord_name}" for coord_name in coord_names]
    if len(points_1) > 0:
    ...
    # FIXME: Use column names instead of indices
...
def local_report(
    ...
    ----------
    block_0 : Block
        block object for channel 0
    block_1 : Block
        block object for channel 1
    df_0 : pd.DataFrame
        dataframe for channel 0
    df_1 : pd.DataFrame
        dataframe for channel 1
    scale : array like
        list of values specifying voxel dimensions. Caution: this scale
        must be shared by both channels.
    coord_names : list[str]
