...
MRI_directory  = '/data_SSD_2to/IRM/P12_T2/1'
...
def transformation(coordinates):
    ...
    coordinates = elx.transform_points(
        coordinates, sink=None,
        transform_directory=MRI_directory  +'/'+ 'elastix_auto_to_chosen_auto_allMRI_landmarks',
        binary=True, indices=False);
...
graph_reduced.transform_properties(transformation=transformation,
                                   vertex_properties={'coordinates_atlas': 'coordinates_mri'},
                                   edge_geometry_properties={'coordinates_atlas': 'coordinates_mri'},
                                   verbose=True);
