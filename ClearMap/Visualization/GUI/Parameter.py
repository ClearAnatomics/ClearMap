...
Provides GUI to parameter dictionaries used in *ClearMap* processing routines

The module effectively implements and interface between parameter dictionaries
and the parameter trees of pyqtgraph
"""
